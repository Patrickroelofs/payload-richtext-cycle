...
export interface News {
  id: number;
  blocks?: (RelationshipBlockType | RichTextBlockType)[] | null;
  updatedAt: string;
  createdAt: string;
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "RelationshipBlockType".
 */
export interface RelationshipBlockType {
  relationship?: {
...
export interface NewsSelect<T extends boolean = true> {
  blocks?:
    | T
    | {
        relationship?: T | RelationshipBlockTypeSelect<T>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "RelationshipBlockType_select".
 */
export interface RelationshipBlockTypeSelect<T extends boolean = true> {
  relationship?: T;
  id?: T;
  blockName?: T;
}
